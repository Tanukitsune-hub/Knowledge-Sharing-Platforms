...
for (const file of ['00_Core.gs', '05_TemporalContracts.gs', '06_CounterpartyMigration.gs', '61_PitchbookValidation.gs', '62_PitchbookIdentity.gs', '30_MeetingCore.gs', '73_ParentRelations.gs', '100_MaintenanceCore.gs', '110_MaintenanceMeetingService.gs', '111_MaintenancePitchbookMasterService.gs', '112_MaintenanceServiceHelpers.gs', '128_RelationshipExplorerService.gs', '129_EntityWorkspaceService.gs']) {
