...
function loadAi() {
  ...
  for (const file of [
    '00_Core.gs','05_TemporalContracts.gs','30_MeetingCore.gs','130_AiConstants.gs','131_AiFileSearchContracts.gs','132_AiKnowledgeContracts.gs','133_AiRetryContracts.gs','161_GeminiRestClient.gs',
