...
function loadAi() {
  ...
  for (const file of [
    ...
    '180_FeatureFreezeFormats.gs','181_FeatureFreezeSync.gs','182_FeatureFreezeKnowledge.gs','190_FeatureFreezeDiagnostics.gs','165_AiProviderAdmin.gs','166_AiModelSetup.gs','170_AiEntryPoints.gs'
  ]) {
