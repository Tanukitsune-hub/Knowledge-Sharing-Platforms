...
const PUBLIC_FACADE_ALLOWLIST = Object.freeze([
  ...
  'getSourceRecordBootstrapData',
  'registerNews',
  'registerAssessment',
  'searchNewsRecords',
  'searchAssessmentRecords',
  'getNewsMaintenanceRecord',
  'getAssessmentMaintenanceRecord',
  'updateNewsMaintenance',
  'updateAssessmentMaintenance',
  'changeNewsStatus',
  ...
  'getAiModelSetupCandidates',
  'getAiCredentialModelCandidates',
  'saveAiModelSetup',
  'saveAiCredentialSetup',
  'getAiModelSetupOperation',
  'removeAiCredential',
  'startAiProvider',
  'getAiSyncCandidates',
  'resetAiProviderDerivedState',
