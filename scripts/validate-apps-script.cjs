...
for(const token of ['id="meeting-form"','id="pitchbook-form"','pitchbook-drop-zone','preparePitchbookBatch','uploadPitchbookFile','25*1024*1024','KSP_PITCHBOOK_SLOT_KEY','id="page-meeting-past"','id="page-pitchbook-past"','id="page-masters"','meeting-quick-add-gp','pitchbook-quick-add-gp','phase1-diagnostics','searchMeetingRecords','updateMeetingMaintenance','mutateMaster','quickAddGp','runAuditRetentionCleanup','getPhase1Diagnostics'])if(!allSource.includes(token))throw new Error(`Source surface missing token: ${token}`);
