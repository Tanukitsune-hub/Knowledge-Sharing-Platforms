...
Only `0017-CODEX-01` may be active. Codex returns report/commit/push/PR update to ChatGPT for final review. No additional dispatch should be invented merely for polishing if the Work acceptance evidence passes.
