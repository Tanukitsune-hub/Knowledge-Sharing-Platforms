...
- generated bundle全文を別メール本文で送付しSENT確認。
- initial empty bundle-body emailはsuperseded。件名`[再送・こちらを使用]`のcorrected resendだけを使用する。
- corrected bundle bodyはcurrent GitHub Contents APIから取得した1,254,351文字のgenerated bundle。
