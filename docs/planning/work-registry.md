...
| 0071 | Interaction-stable async UX — save/upload/status表示によるlayout shiftを抑え、主要action位置を安定化 | PLANNED | Work0070 ACCEPTED baseline | ユーザー開始判断後、記録追加/save/uploadからshared interaction patternを確立 |
