...
- Parent-first、optional Meeting files、required Data Receipt files、related-file unlink semanticsを同じLight familyで視覚化した。
...
- `記録を追加`の`記録種別 = 面談 / データ受領`とparent-first file boundaryを確認した。
