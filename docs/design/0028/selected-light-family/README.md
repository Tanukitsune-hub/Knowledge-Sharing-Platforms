# 選択済みLight family — CODEX-09

現在のreview packageは[最終ユーザー修正](final-user-corrections/README.md)です。
最新[QA](final-user-corrections/design-qa.md)、[検証](final-user-corrections/validation.md)、[画像一覧](final-user-corrections/index.html)を参照してください。
`render-design.py`は現在のCODEX-09 artifactを再生成します。Production source SHAは`7ea55f55278bddfceb03e279f7e536e6b7590c16`、visual baselineはPR #45です。

以下はCODEX-08の履歴です。gold・検索配置・preset設定・面談種別列については上記CODEX-09が優先します。
