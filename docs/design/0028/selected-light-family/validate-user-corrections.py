...
for text in ['記録種別','MEETING','面談','DATA_RECEIPT','データ受領','親記録を先に登録','Meeting_ID','関連資料（任意）','受領資料（必須）','受領背景メモ','親記録の作成に失敗した場合']:
...
for text in ['記録一覧','データ受領','関連資料 3件','資料を追加','削除（紐付け解除）','Meeting_Index.Related_Pitchbook_IDs','PITCHBOOK_NOT_FOUND']:
...
print('PASS: CODEX-10 entity selector, dedicated Meeting-only export action, record-centric IA, 9-column fixture, protected preset and no-network boundaries')
