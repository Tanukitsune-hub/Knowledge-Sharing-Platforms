...
def finalize(out, source, pages):
    ...
    index = '<!doctype html><html lang="ja"><meta charset="utf-8"><title>CODEX-10 Light</title><link rel="stylesheet" href="family.css"><body class="family-index" style="padding:30px"><h1>CODEX-10 · Knowledge Search and record-centric Light corrections</h1><p>設計参照・架空データ。画面内の操作デモのみ。永続保存・サーバー通信はありません。</p><p><a href="action-corrections/index.html">Knowledge Searchのスクリーンショット・比較・検証</a> · <a href="record-centric-qa/index.html">record-centric IAのスクリーンショット・比較・検証</a></p><p><a href="light-only-final-polish/index.html">CODEX-09 Light baseline</a></p><ol>'
