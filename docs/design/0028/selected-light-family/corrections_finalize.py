"""Generate CODEX-09 derived design artifacts; no production imports or mutations."""
import json
import re
...
def finalize(out, source, pages):
    ...
    index = '<!doctype html><html lang="ja"><meta charset="utf-8"><title>CODEX-09 Light</title><link rel="stylesheet" href="family.css"><body class="family-index" style="padding:30px"><h1>CODEX-09 · 最終Light修正</h1><p>設計参照・架空データ。画面内の操作デモのみ。永続保存・サーバー通信はありません。</p><p><a href="final-user-corrections/index.html">最新スクリーンショット・比較・検証</a></p><ol>'
