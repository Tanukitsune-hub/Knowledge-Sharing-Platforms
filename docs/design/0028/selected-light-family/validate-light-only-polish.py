"""Deterministic checks for Work 0028 CODEX-08 inert Light-only design."""
from pathlib import Path
import json
import re

ROOT = Path(__file__).resolve().parent
EXPECTED_SOURCE = "960d225c388912791443cbc68efe5e5426f2a9d2"
EXPECTED_NAV = [
    "ナレッジ検索",
    "記録を追加",
    "過去の記録",
...
require(len(pages) == 14, "expected 14 Light-only pages including one review-only navigation reference")
